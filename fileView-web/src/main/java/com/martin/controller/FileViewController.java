...
import com.martin.task.FileConverQueueTask;
import com.martin.task.FileViewFactory;
...
public class FileViewController extends BaseController {
    ...
    public String onlinePreview(String url, Model model, HttpServletRequest req) {
        ...
        FileViewService filePreview = fileViewFactory.get(url);
