...
public class DownloadUtils {
     ...
     * @return
     */
    public JSONObject downLoad(String urlAddress, String type, String fileName){
        JSONObject res = null;
        URL url = null;
        try {
        ...
        try {
            ...
            os.close();
            in.close();
            res = JsonUtils.getJson(0,"下载成功!!"+fileName,realPath);
            // txt转换文件编码为utf8
            if("txt".equals(type)){
            ...
            if (e instanceof FileNotFoundException) {
                res = JsonUtils.getJson(1,"文件不存在!!!",null);
            }else {
                res = JsonUtils.getJson(1,e.getMessage(),null);
            }
            return res;
        }
    }
